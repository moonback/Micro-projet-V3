...
-- UUID de l'utilisateur: 9370acae-0f10-417c-b998-629b413884b1

-- 1. Tâches de Livraison
INSERT INTO tasks (id, title, description, category, budget, currency, deadline, location, address, author, status, created_at) VALUES
(
  gen_random_uuid(),
  ...
  '9370acae-0f10-417c-b998-629b413884b1',
  'open',
  NOW()
),
(
...
SELECT 
    ...
    COUNT(*) as count
FROM tasks 
WHERE author = '9370acae-0f10-417c-b998-629b413884b1'
